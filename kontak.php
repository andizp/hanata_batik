    ...
    <div class="container info-page-grid">
        ...
        <div class="detail-info">
            ...
            <div class="info-list">
                <div class="info-row">
                    <span>WhatsApp</span>
                    <b><?php echo e(whatsapp_display_number($storeInfo['whatsapp'] ?? '')); ?></b>
                </div>
                <div class="info-row">
                    <span>Email</span>
                    <b><?php echo e($storeInfo['email'] ?? ""); ?></b>
                </div>
                <div class="info-row">
                    <span>Alamat</span>
                    <b><?php echo e($storeInfo['address'] ?? ""); ?></b>
                </div>
                <div class="info-row">
                    <span>Jam Operasional</span>
                    <b><?php echo e($storeInfo['hours_weekday'] ?? ""); ?></b>
                </div>
            </div>
        </div>
    </div>
